...
""")
st.write("""BREAST CANCER WEB APP CREATED BY TUSHANT AGRAWAL
""")

#Get the data
df = pd.read_csv('C:/Users/Yogesh/Desktop/ML Algorithm/Ai production/Breast cancer/1/New folder/breastcancerdetection/streamlitwebMLapp/bc.csv')
#Set a subheader
